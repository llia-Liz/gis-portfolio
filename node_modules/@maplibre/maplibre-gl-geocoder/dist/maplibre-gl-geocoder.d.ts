import Typeahead, { TypeaheadOptions } from 'suggestions-list';
export { default as Typeahead, TypeaheadOptions } from 'suggestions-list';
...
type MaplibreGeocoderSuggestionResults = {
    suggestions: MaplibreGeocoderSuggestion[];
};
...
type MaplibreGeocoderResultsEvent = MaplibreGeocoderResults & {
    config?: MaplibreGeocoderApiConfig;
    features?: CarmenGeojsonFeature[];
};
type TypeaheadFactory = (input: HTMLInputElement, data: (CarmenGeojsonFeature | MaplibreGeocoderSuggestion)[], options: TypeaheadOptions) => Typeahead<CarmenGeojsonFeature | MaplibreGeocoderSuggestion>;
...
declare class MaplibreGeocoder {
    ...
    constructor(geocoderApi: MaplibreGeocoderApi, options: MaplibreGeocoderOptions, typeaheadFactory?: TypeaheadFactory);
    /**
    ...
    _renderMessage(msg: string): void;
    /**
...
export type { CarmenGeojsonFeature, MaplibreGeocoderApi, MaplibreGeocoderApiConfig, MaplibreGeocoderEventTypeMap, MaplibreGeocoderFeatureResults, MaplibreGeocoderOptions, MaplibreGeocoderPlaceResults, MaplibreGeocoderResults, MaplibreGeocoderResultsEvent, MaplibreGeocoderSuggestion, MaplibreGeocoderSuggestionResults, TypeaheadFactory };
